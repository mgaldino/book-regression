...
```{r residuos-sq-preditor, echo=FALSE, message=FALSE}
...
```{r residuos-abs-preditor, echo=FALSE, message=FALSE}
...
```{r residuos-coordenadas, echo=FALSE, message=FALSE}
...
Uma técnica simples, que é uma versão simplificada de algo mais formal chamado "permutation test", é plotar os resíduos permutados aleatoriamente contra a data ou espaço (no nosso caso, espaço).

```{r residuos-shufle-coordenadas, echo=FALSE, message=FALSE}
presid_al18_valido <- presid_al18_valido %>%
  mutate(id_secao = paste0(NR_SECAO, NR_ZONA , CD_MUNICIPIO))
