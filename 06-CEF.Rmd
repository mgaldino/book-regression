...
## Melhor preditor
      ...
      Nós já antecipamos que a esperança conidcional é o melhor preditor de $Y$. vamos agora mostrar isso.
...
A CEF linear é um caso particular.
...
Entre os lineares, a esperança condicional é o melhor.

Fórmula do Beta.

Se tiver multicolineareade, a matriz não é invertível e não é identificada.
