...
outro teorema, chamdo de lei da esperanças iteradas (Law of Iterated
Expectation) que diz que a esperança da esperança condicional é a
esperança não-condicional. Ou seja,\$\mathbb{E}[\mathbb{E}[Y\|X]] =
\mathbb{E}[Y]. Utilizando esse fato, temos que a esperança
...
o casto particular de X assumindo dois valores).
