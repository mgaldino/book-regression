...
Para gerar tabelas em Rmarkdown, uso três funções (deveria ser mais consistente e usar só uma ou duas), `kable` do **knitr**, `gt` do pacote de mesmo nome e a função `etable` do pacote **fixest**, quando rodo regressões desse pacote.
