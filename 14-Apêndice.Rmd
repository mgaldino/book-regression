...
Para visualização, uso o ggplot e pacotes que dialogam com o ggplot. A única exceção é para plotar o gráfico da logística, que usei o R base e a função curve.

## Limpeza de dados
Para limpeza de dados, além do tidyverse, uso o pacote janitor (particularmente a função clean_names) e lubridate para trabalhar com datas. Com relação a textos, stringr.

## Modelagem de dados
Para regressões limpes, uso o R base e suas funções lm e glm. Para dados em painel, prefiro fixest, que evita de eu ter de chamar o pacote sandwich para erro padrão robusto. Para modelos Bayesianos, vario entre rstanarm e brms.

## Outros
Checagem do modelo, o pacote performance.
Para instalação do gihutb, devtools.
