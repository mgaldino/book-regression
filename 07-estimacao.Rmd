...
É possível mostrar que o preditor linear ótimo com um único regressor é possui intercepto
...
Agora, vamos calcular a variância da média amostral sob a sposição de que a amostra é i.i.d. Considerando $Y_i = \mu + e_i$, temos:
...
Tendo mostrado que o estimador é não-viesado e calculado a variância amostral para o caso mais simples, sem preditor, vamos agora fazer o mesm ocálculo com um preditor.
...
```{r package base de dados, echo=T, message=FALSE, cache=T}
...
```{r base alunos, echo=T, message=FALSE, cache=T}
