...
$$
\hat{\beta} = \sum({x_i - \bar{x}}) \cdot ({y_i - \bar{y}})/\mathbb{Var}[x] = \sum{(x_i - \bar{x}) \cdot y_i - (x_i - \bar{x})\bar{y}}/\mathbb{Var}[x] =  (\sum({x - \bar{x}}) \cdot y_i - \sum({x -\bar{x}}) \cdot\bar{y})/\mathbb{Var}[x] 
$$
