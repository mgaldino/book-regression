...
Para importar dados, vamos usar a biblioteca "data.table"
...
# o arquivo está em formato RDS, que é um formato do R, e disponível no meu github. Para importá-lo direto no R, vamos ler o arquivo com a função url e depois importá-lo com a função readRDS.
